							...
							<li><select class="form-select form-select-sm"
								...
								onchange="if(this.value) location.href=(this.value);">
									...
									<option value="${cp }/shop/goods_list_pro_top?cg_id=6&order=2">낮은
										가격순</option>
									<option value="${cp }/shop/goods_list_pro_top?cg_id=6&order=3">높은
										가격순</option>
							</select></li>
						</ul>
						...
						<ul class="goods_list_box_category">
							...
							<li><select class="form-select form-select-sm"
								...
								onchange="if(this.value) location.href=(this.value);">
									...
									<option value="${cp }/shop/goods_list_pro_top?p_id=2&cg_id=3&order=1">신상품순</option>
									<option value="${cp }/shop/goods_list_pro_top?p_id=2&cg_id=3&order=2">낮은
										가격순</option>
									<option value="${cp }/shop/goods_list_pro_top?p_id=2&cg_id=3&order=3">높은
										가격순</option>
							</select></li>
						</ul>
						<div class="goods_list_imgbox_wrap">
