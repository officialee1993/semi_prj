...
public class pro_cate_storage_list_vo {
	...
	public pro_cate_storage_list_vo() {}
	
	
	public pro_cate_storage_list_vo(int p_num, String p_name, int p_count, int p_price, int p_click_num, Date p_date,
			String save_img_name, String cg_name, int s_count, String p_size) {
		super();
		this.p_num = p_num;
		this.p_name = p_name;
