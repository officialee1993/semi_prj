...
public class OrderDao {
	...
	public int goodorder_insert(String rec_name, String rec_phone, String rec_addr, int ALL_SUM_PRICE, String payname,
			String O_STATE, String id, int p_num, int b_num_max) {
		Connection con = null;
	...
	public Orders_vo ordervoinfo() {
		...
		try {
			...
			if (rs.next()) {
				...
				ordervo = new Orders_vo(rs.getInt("O_NUM"), rs.getString("REC_NAME"), rs.getString("REC_PHONE"),
						rs.getString("REC_ADDR"), rs.getInt("ALL_SUM_PRICE"), rs.getString("PAYNAME"),
						rs.getDate("O_DATE"), rs.getString("O_STATE"), rs.getString("ID"), rs.getInt("P_NUM"),
						rs.getInt("B_NUM"));
	...
	public ArrayList<Product_Orderlist_vo> ordervo_list_info(String id) {
		...
		try {
			...
			while (rs.next()) {
				...
				product_orderlist_vo = new Product_Orderlist_vo(rs.getInt("O_NUM"), rs.getString("REC_NAME"),
						rs.getString("REC_PHONE"), rs.getString("REC_ADDR"), rs.getInt("ALL_SUM_PRICE"),
						rs.getString("PAYNAME"), rs.getDate("O_DATE"), rs.getString("O_STATE"), rs.getString("ID"),
